...
from . import views
from .views_factcheck_api import FactcheckAPIView


from .views import (ImageFactcheckAPI, result_detail_hausa,result_detail_arabic,result_detail_french,result_detail_igbo,result_detail_swahili,result_detail_yoruba,fact1,index,hausa,igbo, yoruba,french,habout,hausa_result,yabout,
                    ...
                    reliable_sources,yoruba_result,igbo_result,french_result,internet_safety,privacy_policy,
                    # FactcheckAPI,FactCheckWithTavilyAPIView,
                    # FactCheckAPIView,factcheck_webpage,combined_view,
                    combine
                    )
from rest_framework import routers
from .views import ImageFactcheckAPI, UploadImgbbAPI
...
urlpatterns = [
    ...
    path("api/factcheck/", FactcheckAPIView.as_view(), name="api-factcheck"),

    path("api/image-factcheck", ImageFactcheckAPI.as_view(), name="image-factcheck"),
    path("api/upload-imgbb", UploadImgbbAPI.as_view(), name="upload-imgbb"),
